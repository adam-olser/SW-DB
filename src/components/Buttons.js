...
const Buttons = ({onClickPeople, onClickShips, onClickFilms, onClickSpecies}) => {
    return(
        <div className="container">
            ...
            <button className="f6 grow no-underline br-pill ph3 pv2 mb2 dib white bg-black btn yellow" src="#" alt="" value='starships' onClick={onClickShips}>Starships</button>
            <button className="f6 grow no-underline br-pill ph3 pv2 mb2 dib white bg-black btn yellow" src="#" alt="" value='species' onClick={onClickSpecies}>Species</button>
        </div>
